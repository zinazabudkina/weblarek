...
import { ServerCommunication } from "./components/base/ServerCommunication.ts";
...
products.setSelectedProduct(
  products.getProductById("854cef69-976d-4c2a-a18c-2aa45046c390") as IProduct,
);
console.log(
...
const cart = new Cart();
const exampleItem1: IProduct = products.getProductById(
  "854cef69-976d-4c2a-a18c-2aa45046c390",
) as IProduct;
const exampleItem2: IProduct = products.getProductById(
...
server.getProducts().then((result) => {
